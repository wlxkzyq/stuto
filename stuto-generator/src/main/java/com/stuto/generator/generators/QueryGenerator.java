 ...
 * query类生成器
 * @author 作者 : zyq
 * 创建时间：2019/3/25 13:52
 * @version 0.0.1
 */
public class QueryGenerator extends DefaultTopLevelClassGenerator {
    public QueryGenerator(IntrospectedTable table) {
        this.introspectedTable = table;
    }

    protected static final String GENERATOR_NAME = "QueryGenerator";
