...
import com.stuto.generator.generators.ViewGenerator;

/**
 * @author 作者 : zyq
 * 创建时间：2019/3/25 11:21
 * @version 0.0.1
 */
public class ViewGeneratorTw extends ViewGenerator {

    public ViewGeneratorTw(IntrospectedTable table) {
        super(table);
    }
