...
import static com.stuto.generator.util.StringUtility.stringHasValue;
...
public class FullyQualifiedJavaType implements
    ...
    public static final FullyQualifiedJavaType getNewListInstance(String genericity) {
        // always return a new instance because the type may be parameterized
        return new FullyQualifiedJavaType("java.util.List"+"<"+genericity+">"); //$NON-NLS-1$
    }
